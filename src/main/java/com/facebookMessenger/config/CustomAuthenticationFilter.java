 ...
 */
@Slf4j
public class CustomAuthenticationFilter extends UsernamePasswordAuthenticationFilter implements ChannelInterceptor {
 ...
 UsernamePasswordAuthenticationToken authenticationToken;
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        log.info("Username is: {}", user); log.info("Password is: {}", password);
         ...
         authenticationToken = new UsernamePasswordAuthenticationToken(user, password);
